// cburnett chess piece set by Colin M.L. Burnett, CC-BY-SA 3.0.
// Source: https://github.com/lichess-org/lila/tree/master/public/piece/cburnett
// (originally https://en.wikipedia.org/wiki/User:Cburnett)
import type { PieceChar, PieceRenderer } from "../types";

const svg = (inner: string): PieceRenderer => (size) => (
  <svg
...
export const defaultPieceMap: Record<PieceChar, PieceRenderer> = {
  K: WhiteKing,
  Q: WhiteQueen,
  R: WhiteRook,
  B: WhiteBishop,
